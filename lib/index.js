...
var _default = function _default(props) {
  var onClick = props.onClick,
      _getChild = props.getChild,
      rootData = props.rootData,
      childData = props.childData,
      rootName = props.rootName,
      _props$data = props.data,
      allData = _props$data === void 0 ? [] : _props$data,
  ...
  (0, _react.useEffect)(function () {
    if (!rootHasRender && (rootData === null || rootData === void 0 ? void 0 : rootData.length) > 0 && (allData === null || allData === void 0 ? void 0 : allData.length) === 0) {
      // 初始数据渲染根节点数据
      var arr = [];
      var initArr = [];
    ...
    } else if (rootHasRender && (allData === null || allData === void 0 ? void 0 : allData.length) === 0 && path) {
      // 渲染子节点数据
